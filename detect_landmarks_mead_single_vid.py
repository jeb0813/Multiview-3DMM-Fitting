    ...
    for emo_folder in emo_folders:
        ...
        for level_folder in level_folders:
            ...
            for trial_folder in trial_folders:
                ...
                source_folder_trial = os.path.join(cfg.data_source, emo_folder, level_folder, trial_folder, 'images')
                output_folder_trial = os.path.join(cfg.data_source, emo_folder, level_folder, trial_folder, 'landmarks')
                os.makedirs(output_folder_trial, exist_ok=True)
                frames = sorted(os.listdir(source_folder_trial))

                for frame in tqdm.tqdm(frames):
                    if 'background' in frame:
                        continue
                    source_frame_folder = os.path.join(source_folder_trial, frame)
                    output_frame_folder = os.path.join(output_folder_trial, frame)
